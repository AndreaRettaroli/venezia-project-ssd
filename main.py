...
from constants import MONTH_LOOK_BACK, WEEK_LOOK_BACK
...
if __name__ == '__main__':
    ...
    # df_floor2 = pd.DataFrame(list(cursors_floor_2))  # Timestamp every 1 minute
    ...
    # df_floor2 = df_floor2.iloc[1::10, :]  # Every 10 minutes
